...
-- Perusahaan
INSERT INTO perusahaan (nama, alamat, kode_pos, telepon, email, fax, provinsi_kode, kab_kota_kode, kecamatan_kode, desa_kelurahan_kode, nama_pic, telepon_pic, jabatan_pic, jenis_kelamin_pic, unit_kerja_pic, status, latitude, longitude, kbli, kantor_pusat_id, grup_perusahaan_id, status_pemodalan, bentuk_badan_hukum, pelaksana_kemitraan, kebun_plasma_konversi, punya_unit_pengolahan_produksi, tahun_berdiri, jenis_perusahaan_tebu, stok_pabrik_gula, stok_pedagang, stok_petani)
VALUES 
('Perusahaan Tebu Subur', 'Jl. Subur No. 5', '60295', '021456789', 'admin@tebusubur.com', '021456780', '01', '01', '001', '001', 'Budi Darmawan', '08123456789', 'Manager', '1', 'Pengolahan', 'aktif', -6.175110, 106.865039, '011', 1, 1, '1', '1', '1', '1', '1', 1985, '1', 1000.0, 500.0, 200.0),
('Perusahaan Tebu Sejahtera', 'Jl. Subur No. 6', '60298', '021567892', 'admin@tebusejahtera.com', '021567893', '02', '02', '002', '002', 'Agus Santoso', '08134567890', 'Manager', '1', 'Pengolahan', 'aktif', -6.200000, 106.900000, '012', 2, 2, '2', '1', '1', '1', '1', 1990, '2', 1500.0, 700.0, 300.0),
('Perusahaan Tebu Maju', 'Jl. Maju No. 25', '60299', '021678903', 'admin@tebumaju.com', '021678904', '02', '02', '002', '002', 'Rina Wijaya', '08145678901', 'Manager', '2', 'Pengolahan', 'aktif', -6.210000, 106.910000, '013', 1, 2, '3', '1', '1', '1', '1', 2000, '3', 2000.0, 800.0, 400.0),
('Perusahaan Tebu Makmur', 'Jl. Makmur No. 30', '60300', '021789012', 'admin@tebumakmur.com', '021789013', '03', '03', '003', '003', 'Andi Suryadi', '08156789012', 'Manager', '1', 'Pengolahan', 'aktif', -6.220000, 106.920000, '014', 2, 1, '4', '1', '1', '1', '1', 1995, '1', 2500.0, 900.0, 500.0);

-- Kebun
INSERT INTO kebun (perusahaan_id, nama_kebun, provinsi_kode, kab_kota_kode, luas_areal_tanam, produk_utama, luas_areal_tebang, kode_kbki, produksi_tebu, produksi_gkp, produksi_tetes, produksi_hablur, rendemen_hablur)
VALUES 
(1, 'Tebu Sendiri', '01', '01', 500.0, 'Tebu', 500.0, 'A123', 10000.0, 5000.0, 2500.0, 1250.0, 12.5),
(2, 'Tebu Sendiri', '02', '02', 600.0, 'Tebu', 600.0, 'B123', 12000.0, 6000.0, 3000.0, 1500.0, 12.5),
(2, 'Tebu Rakyat', '02', '02', 300.0, 'Tebu', 300.0, 'B124', 6000.0, 3000.0, 1500.0, 750.0, 12.5),
(2, 'Pembelian dari Pihak Ketiga', '02', '02', 100.0, 'Tebu', 100.0, 'B125', 2000.0, 1000.0, 500.0, 250.0, 12.5),
(3, 'Tebu Sendiri', '02', '02', 700.0, 'Tebu', 700.0, 'C123', 14000.0, 7000.0, 3500.0, 1750.0, 12.5),
(4, 'Tebu Sendiri', '03', '03', 800.0, 'Tebu', 800.0, 'D123', 16000.0, 8000.0, 4000.0, 2000.0, 12.5),
(4, 'Tebu Rakyat', '03', '03', 400.0, 'Tebu', 400.0, 'D124', 8000.0, 4000.0, 2000.0, 1000.0, 12.5);
...
SELECT 
    p.*, 
    kp.nama AS nama_kantor_pusat, kp.alamat AS alamat_kantor_pusat, kp.kode_pos AS kode_pos_kantor_pusat, kp.telepon AS telepon_kantor_pusat, 
    kp.email AS email_kantor_pusat, kp.fax AS fax_kantor_pusat, 
    gp.nama AS nama_grup_perusahaan, gp.alamat AS alamat_grup_perusahaan, gp.kode_pos AS kode_pos_grup_perusahaan, 
    gp.telepon AS telepon_grup_perusahaan, gp.email AS email_grup_perusahaan, gp.fax AS fax_grup_perusahaan,
    k.nama_kebun, k.produksi_tebu, k.produksi_gkp, k.produksi_tetes, k.produksi_hablur, k.rendemen_hablur,
    kpnc.nama_pencacah, kpnc.tanggal_mencacah, kpnc.nama_pemeriksa, kpnc.tanggal_memeriksa
FROM 
    perusahaan p
LEFT JOIN 
    kantor_pusat kp ON p.kantor_pusat_id = kp.id
