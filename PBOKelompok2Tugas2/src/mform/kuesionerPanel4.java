 ...
 * @author USER
 */
public class MF_BlokV extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MF_BlokV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
